...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        let branch_color = this.hexToRgbA("#8b4513");
        this.branch = new CGFappearance(this);
        this.branch.setAmbient(branch_color[0], branch_color[1], branch_color[2], 1);
        this.branch.setDiffuse(branch_color[0], branch_color[1], branch_color[2], 1);
        this.branch.setSpecular(0.1, 0.1, 0.1, 1);
